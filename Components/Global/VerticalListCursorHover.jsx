...
const VerticalListCursorHover = ({ children, className = "", parentClassName = "" }) => {
  ...
  return (
    <div
      ...
      ref={ContainerRef}
      className={`${parentClassName}  flex relative pb-[2px]  items-center justify-center gap-2`}>
      {children}
      {
        iSHovrinbg &&
        <span
          ...
          ref={SliderRef}
          className={`${className} opacity-60  absolute bottom-0 p-[1px] bg-[#b88402] w-[50px]`}></span>
      }
    </div >
  )
}
